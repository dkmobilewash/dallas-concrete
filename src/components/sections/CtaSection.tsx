    ...
    <section className="bg-brand-orange py-16 md:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href={site.phoneHref} className="inline-flex items-center gap-2 bg-white text-brand-orange hover:bg-brand-gray-light font-bold px-8 py-4 rounded-md text-lg transition-colors">
