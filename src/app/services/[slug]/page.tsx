...
const serviceContent: Record<string, {
  ...
  'concrete-walkways': {
    overview: [
      'Concrete walkways serve a dual purpose: they provide safe, accessible paths across your property and they contribute significantly to curb appeal. A well-designed walkway guides visitors from the curb to your front door, connects outdoor living areas, and creates defined paths through landscaping. Poorly maintained or uneven walkways create trip hazards and liability issues.',
    ...
    faqs: [
      ...
      { question: 'Can you match a walkway to an existing patio or driveway?', answer: 'We can match the color and finish of new walkways to existing concrete, though there will always be some variation due to aging and weathering of the original surface. We will show you options and set realistic expectations.' },
      ...
      { question: 'Do you install walkways for commercial properties?', answer: 'Yes. We install commercial walkways that meet ADA requirements and local building codes. This includes proper width, slope, cross-slope, detectable warning surfaces at curb ramps, and appropriate joint spacing.' },
    ],
  },
  'concrete-foundations': {
    ...
    faqs: [
      { question: 'What type of foundation is best for Dallas soil?', answer: 'Post-tension slab foundations are the most common choice for new construction in the Dallas area because they handle the movement of expansive clay soils better than conventional foundations. Your structural engineer will determine the best type based on a geotechnical soil report.' },
      ...
      { question: 'How long does a foundation pour take?', answer: 'A typical residential foundation pour takes 1-2 days for the actual concrete placement. However, the full process including excavation, plumbing, reinforcement, and curing spans 2-3 weeks depending on the size and complexity of the project.' },
    ],
  },
  'retaining-walls': {
    overview: [
      'Retaining walls serve both structural and aesthetic purposes on properties with grade changes, drainage challenges, or erosion issues. A properly engineered retaining wall holds back soil, redirects water flow, and creates usable flat areas on sloped lots. In the Dallas area, where thunderstorms can deliver heavy rainfall in short periods, retaining walls play a critical role in protecting landscapes and structures.',
    ...
    faqs: [
      { question: 'How tall can a concrete retaining wall be?', answer: 'Walls up to 4 feet can often be built with standard designs. Walls taller than 4 feet typically require engineered plans with a stamped structural drawing. We handle walls of all sizes and coordinate engineering when required.' },
      { question: 'What causes retaining walls to fail?', answer: 'The most common cause of retaining wall failure is inadequate drainage behind the wall. Water builds up hydrostatic pressure that pushes the wall forward. Proper drainage systems, gravel backfill, and weep holes prevent this.' },
      { question: 'Is a tiered retaining wall better than a single tall wall?', answer: 'For grade changes over 4-5 feet, tiered walls are often a better choice. They distribute soil pressure across two or more walls, require less engineering, and are typically more attractive with planting areas between tiers.' },
      { question: 'Do retaining walls need a footer?', answer: 'Yes. A reinforced concrete footer below grade is essential for wall stability. The footer width and depth depend on the wall height and soil conditions. Skipping the footer is the most common mistake in DIY retaining wall projects.' },
    ],
  },
  'stamped-concrete': {
    overview: [
      'Stamped concrete delivers the appearance of natural stone, brick, or slate at a fraction of the cost, with the durability and low maintenance of standard concrete. It is one of the most popular decorative concrete options for Dallas homeowners, used on patios, driveways, walkways, and pool decks to create a high-end look without the expense of natural materials.',
      'Dallas Concrete Solutions offers a range of stamp patterns including ashlar slate, cobblestone, flagstone, and wood plank designs. We use integral color, color hardeners, and release agents to create realistic, multi-toned finishes. Every stamped concrete project includes a high-quality sealer that protects the color from UV fading in the intense Texas sun and makes the surface easier to clean and maintain.',
    ],
    benefits: [
    ...
    faqs: [
      ...
      { question: 'Is stamped concrete slippery when wet?', answer: 'The texture from the stamp pattern provides some traction, but sealed stamped concrete can be slippery when wet. For pool decks and slopes, we can add a non-slip additive to the sealer that significantly improves wet traction.' },
      { question: 'What is the best stamp pattern for a driveway?', answer: 'Ashlar slate and cobblestone are the most popular driveway patterns because they complement most home styles and age well. We will show you pattern samples and help you choose based on your home\'s architecture.' },
      { question: 'How often does stamped concrete need to be resealed?', answer: 'In the Dallas area, we recommend resealing every 2-3 years. The intense Texas sun breaks down sealer faster than in cooler climates. We offer resealing as a maintenance service for our customers.' },
    ],
  },
  'commercial-concrete': {
    overview: [
    ...
    faqs: [
      { question: 'Can you work around our business hours?', answer: 'Yes. We regularly schedule commercial pours for early mornings, evenings, or weekends to minimize disruption to your business. We will create a phased plan that keeps your operation running throughout the project.' },
      { question: 'What thickness is required for a commercial parking lot?', answer: 'Commercial parking lots typically require 5-6 inches of concrete over a compacted aggregate base. Areas with heavy truck traffic, dumpster pads, or loading docks may require 8 inches or more with additional reinforcement.' },
      ...
      { question: 'How long does a commercial concrete project take?', answer: 'Timeline depends on scope. A small storefront sidewalk may take 2-3 days, while a full parking lot project can span several weeks with phased pours. We provide detailed schedules before work begins.' },
    ],
  },
}
          ...
          <div className="space-y-6">
            {content.process.map((step, i) => (
              <div key={step.step} className="flex gap-4">
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-brand-orange text-white font-bold text-sm shrink-0">
                  {i + 1}
                </div>
                <div>
