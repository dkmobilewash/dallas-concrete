...
export default function ContactForm({ services, cities }: ContactFormProps) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <select
            ...
            name="service"
            required
            className="w-full border border-brand-gray-mid rounded-md px-4 py-2.5 text-brand-charcoal focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent bg-white"
          >
      ...
      <button
        type="submit"
        className="bg-brand-orange hover:bg-brand-orange-dark text-white font-semibold px-8 py-3 rounded-md transition-colors"
      >
        Submit Request
      </button>
    </form>
